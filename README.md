...
Дано:
•	Разрабатываемая система обрабатывает сущности User, Story, Label и Comment, которые логически связаны отношениями (см. предыдущие задачи)
o	один-ко-многим (User и Story, Story и Comment)
o	многие-ко-многим (Story, Label).
•	В Kafka настроена передача между модулями publisher и discussion сущности Comment.
•	User(s), Story(s), Label(s) хранятся в Postgres.
